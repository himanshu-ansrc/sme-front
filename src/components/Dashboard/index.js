...
class Dashboard extends React.Component {
  ...
  componentDidMount(){
      console.log("load dashborad")
      this.props.load_dashboard();
  }
    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <Divider />
          <List>
                <MainListItems loadList={this.state.mainList}/>
          </List>
        </Drawer>
...
export default connect(state=>state, actions)(withStyles(styles)(Dashboard));
